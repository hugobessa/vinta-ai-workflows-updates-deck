...
export const meta = { title: "Slide 40" };

export interface Slide40Props {
...
// Parametrized reproduction of the official template's Slide 40 (code, light, side photo).
export default function Slide40({
  ...
  return (
    <Slide bg="white" pad={false}>
      <Place x={0} y={0} w={750.9} h={1080}><Photo src="img-7cfded07c9.png" inner={{ x: 0, y: 0, w: 1919.97, h: 1080 }} /></Place>
      <Place x={483.36} y={873.41} w={109} h={108.55}><Photo src="img-16976e8428.png" /></Place>
      <Place x={849.6} y={109.2} w={971.7} h={861.7}>
